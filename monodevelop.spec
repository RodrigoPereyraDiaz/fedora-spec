...
Source0:        http://download.mono-project.com/sources/%{name}/%{name}-%{version}.0.660.tar.bz2
BuildRequires:  mono-devel >= 3.0.4 mono-addins-devel >= 0.6 mono-nunit-devel
...
%changelog
* Fri Jan 16 2015 Claudio Rodrigo Pereyra Diaz <elsupergomez@fedoraproject.org> - 5.7.0.660-1
- Update to 5.7.0.660
