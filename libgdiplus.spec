...
%build
%configure --disable-static CFLAGS=-Wno-deprecated-declarations
make %{?_smp_mflags}
...
%changelog
* Fri Jan 09 2015 Claudio Rodrigo Pereyra Diaz <elsupergomez@fedoraproject.org> - 3.12-1
- Update to 3.12

* Thu Dec 11 2014 Claudio Rodrigo Pereyra Diaz <elsupergomez@fedoraproject.org> - 3.8-2
- CFLAGS=-Wno-deprecated-declarations to prevent deprecated warnings as error

* Mon Dec 01 2014 Claudio Rodrigo Pereyra Diaz <elsupergomez@fedoraproject.org> - 3.8-1
- Update to 3.8
