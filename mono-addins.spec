...
Source0:	https://github.com/mono/mono-addins/archive/mono-addins-%{version}.tar.gz
...
%{_prefix}/lib/mono/gac/policy.*.Mono.Addins
%{_prefix}/lib/mono/gac/policy.*.Mono.Addins.Gui
%{_prefix}/lib/mono/gac/policy.*.Mono.Addins.Setup
%{_prefix}/lib/mono/gac/policy.*.Mono.Addins.CecilReflector

%{_mandir}/man1/mautil.1.gz

%files devel
%defattr (-,root,root,-)
%{_prefix}/lib/mono/gac/policy.*.Mono.Addins.MSBuild
...
%changelog
* Thu Jan 30 2014 Claudio Rodrigo Pereyra Diaz <elsupergomez@fedoraproject.org> - 1.1-1
- Update to 1.1
- Clean and simplify spec

* Thu Nov 21 2013 Claudio Rodrigo Pereyra Diaz <elsupergomez@fedoraproject.org> - 1.0-1
- Update to 1.0
